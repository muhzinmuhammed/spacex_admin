...
<html lang="en">
                            ...
                            <div class="agent-views">
								...
								<div class="list-card">
									<ul class="my-list nav">
										<li>
											<a href="#" class="active" data-bs-toggle="tab" data-bs-target="#property">All Properties <?php ($countTrueStatus) ?></a>
										</li>
										<!-- <li>
    ...
    <div class="agentview-slider owl-carousel feature-property-sec for-rent">
        ...
        try {
            ...
            // Initialize a counter to keep track of the loop index
            $counter = 0;

            // Loop through properties and display those with status == true
            foreach ($properties as $key => $property) {
                if ($property['status'] == true) {
                    // Set the image based on the index
					if ($counter%3==0) {
						$imagePath = './assets/img/product/product-7.jpg'; 
					}
                   // Default image

                    // Change image based on the counter value
                    if ($counter%3 == 1) {
                        $imagePath = './assets/img/product/product-6.jpg';
                    } elseif ($counter%3 == 2) {
                        $imagePath = './assets/img/product/product-8.jpg';
                    }
                    ...
                    <div class="product-custom">
                        <div class="profile-widget">
                            <div class="pro-img">
                                <a href="rent-details.php?id=<?php echo urlencode($key); ?>" class="property-img">
                                    <img class="img-fluid" alt="Property Image" src="<?php echo $imagePath; ?>">
                                </a>
                            ...
                            <div class="pro-content">
                                ...
                                <h5><?php echo htmlspecialchars($property['userName']); ?></h5>
                            </div>
                        </div>
                    </div>
                    <?php
